...
public class DoctorRegisterAction extends ActionSupport implements SessionAware {
	...
	public String execute() throws Exception {
		if(checkRegisterInformationValid()) {
			Doctor newDoctor = new Doctor(physicianLicenseNum, password);
	...
	private boolean checkRegisterIdValidAndAddFieldError() {
		...
		this.addFieldError("physicianLicenseNum", "医师资格证号只能由字母、数字和下划线组成, 长度为8到20位");
		return false;
	}
