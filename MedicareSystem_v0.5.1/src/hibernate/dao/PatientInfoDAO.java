...
public class PatientInfoDAO extends BaseHibernateDAO {
	...
	public PatientInfo findById(java.lang.String id) {
		...
		try {
			PatientInfo instance = (PatientInfo) getSession().get(
					"hibernate.vo.userinfo.PatientInfo", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(PatientInfo instance) {
		log.debug("finding PatientInfo instance by example");
		try {
			List results = getSession().createCriteria(
					"hibernate.vo.userinfo.PatientInfo").add(
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding PatientInfo instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from PatientInfo as model where model."
					+ propertyName + "= ?";
	...
	public void attachDirty(PatientInfo instance) {
