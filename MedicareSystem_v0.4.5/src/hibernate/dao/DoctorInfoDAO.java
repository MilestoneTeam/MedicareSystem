	...
	public List<DoctorInfo> findByExample(DoctorInfo instance) {
		...
		try {
			List results = getSession().createCriteria(
					"hibernate.vo.DoctorInfo").add(Example.create(instance))
					.list();
